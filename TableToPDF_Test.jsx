...
var  img_src = "V:/STATE CONTRACTS/TX_EQRO/HOP_TX/TexasReports/Contract_Deliverables/MCO Report Cards/Resources/Images on report cards/star_pngs/", 
...
// set language
    ...
    var ReportCardsExportFormat = app.pdfExportPresets.itemByName("ReportCardsExportFormat_" + lang);
...
// file name and export
    ...
    if ( lang == "ES" ) {
        headerCell = "Plan médico" ;
    }
    else {
        headerCell = "Health Plan" ;
    }

    ratTable.cells[0].contents = headerCell ;
