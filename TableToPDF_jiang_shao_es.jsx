...
var descriptionTitle ;
        switch(lang) {
            case "EN":
                sdaNameTF.contents = SDA_name + " " + sdaNameTF.contents ;
...
// file name and export
    ...
    fname = fname + " - " + SAName ;
    ratTable.cells[0].contents = "Plan médico" ;
    fname = fname.replace ("Medicaid Rural Service Area", "MRSA")
    fname = fname.replace ("Rural Service Area", "RSA")
    fname = fname.replace ("–", "-")

    rcDoc.exportFile(ExportFormat.INTERACTIVE_PDF, File(fname + fileVersionSuffix + ".pdf"), false, "ReportCardsExportFormat_ES") ;

    //rcDoc.exportFile(ExportFormat.INTERACTIVE_PDF, File(fname + fileVersionSuffix + ".pdf"), false, app.pdfExportPresets.item("ReportCardsExportFormat_ES")) ;
    //rcDoc.exportFile(ExportFormat.INTERACTIVE_PDF, File(fname + fileVersionSuffix + ".pdf"), false, app.pdfExportPresets.itemByName("ReportCardsExportFormat_ES")) ;
